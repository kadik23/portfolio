...
function Project({ project }: ProjectProps) {
    return (
        <div className="min-w-full px-8 h-auto flex items-center lg:scale-90">
            <div className="mt-4 flex flex-col lg:flex-row justify-between w-full">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <div className="space-2 inika-regular capitalize mt-4 w-80 lg:w-96 first-letter:ml-4">{project.description}</div>
                    <div className="flex flex-wrap gap-4 justify-start mt-4 w-80 lg:w-96">{project.frameworks.map((framework, index) => (
